...
335. **驗證方式：Playwright啟動本機靜態伺服器實測**——完成LO練習前7題後導覽至第8題，確認按鈕文字變為「繳卷」；點「上一題」回到第7題，確認按鈕文字恢復「下一題」；再前進到第8題點擊「繳卷」，確認正確觸發`submitQuiz`並顯示結果畫面；左側按鈕文字確認顯示「結束測驗」。皆符合預期。## 2026-09-08 第二輪干擾選項稽核：補漏56題自我矛盾選項＋清除113處「其實/反而」洩題用語（commit 3c81290）
