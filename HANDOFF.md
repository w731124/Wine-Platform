...
以上已 commit，**尚未 push**。**本次刻意只做氣泡酒一款，未套用到紅/白/粉紅/橘酒/強化酒，等使用者審核氣泡酒內容與畫面後才決定下一步。**

## 二、討論過但尚未執行的項目／下一步規劃

- **釀造工藝頁面其餘5款（紅/白/粉紅/橘酒/強化酒）**——待使用者確認氣泡酒試點的內容品質與欄位結構後才能動工，不要自行假設已核准而逕自擴充。
...
- **本次 session 異動範圍**：`index.html`（啟用釀造工藝導覽項＋新增panel）、`data/wine-data.js`（新增 `wineStyles[]`，僅1筆）、`js/winestyles.js`（新檔）、`js/core.js`（DOMContentLoaded加一行）、`DECISIONS.md`、`HANDOFF.md`。
