...
const QUIZ_BANK = [
  ...
  },
  {
    ...
    sourceType: 'wset-spec-supplement',
    sourceId: 'grape-ripening-changes',
    question: '白葡萄與黑葡萄在成熟過程中，香氣/風味的典型變化方向為何？',
    options: [
      '白葡萄香氣多半由熱帶水果逐漸轉回柑橘、青蘋果等清爽調性；黑葡萄則由黑色漿果轉回紅色漿果調性',
      '白葡萄由生青／高酸的柑橘調性逐漸轉為核果、熱帶水果等成熟果香；黑葡萄則由紅色漿果轉為黑色漿果甚至蜜餞乾果調性，同時單寧與糖分成熟度提升',
      '兩者的香氣/風味變化模式完全相同，皆由柑橘轉為熱帶水果',
      '成熟過程中只有糖分持續累積，香氣調性本身不會隨之改變'
    ],
    correctIndex: 1,
    explanation: '隨著葡萄成熟，白葡萄香氣通常由生青、高酸的柑橘調性逐漸發展為核果、熱帶水果等更成熟的果香；黑葡萄則由紅色漿果調性轉為黑色漿果甚至蜜餞乾果調性，同時單寧與糖分成熟度也隨之提升，是官方規格中葡萄成熟度光譜的核心概念。'
  },
  {
    id: 'lo1-011',
    lo: 1,
