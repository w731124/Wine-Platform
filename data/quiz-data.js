...
const QUIZ_BANK = [
  ...
  },
  {
    ...
    options: [
      ...
      '義大利Pinot Grigio才具備長期陳年實力；阿爾薩斯版本反而多走清淡早飲路線'
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      '其香氣調性其實更接近Cabernet Sauvignon的黑色果香系，而非花香'
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      'Syrah/Shiraz單寧反而遠高於Cabernet Sauvignon，是所有品種中最厚重的',
  ...
  },
  {
    ...
    options: [
      '這些別名其實是完全不同的獨立品種，外觀相似',
      '只有Rioja才種植這個品種，其他產區沒有別名',
      '這些別名其實是專指釀造甜酒版本的稱呼',
  ...
  },
  {
    ...
    options: [
      '兩者風味特徵幾乎完全相同，難以區分辨別',
      '山吉歐維榭酸度反而較低，田帕尼優酸度較高',
      '田帕尼優酸度低單寧緊實；山吉歐維榭高酸酸櫻桃',
      '田帕尼優反而以酸櫻桃調性為特徵，山吉歐維榭單寧更緊實'
    ],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: [
      '兩者風味特徵幾乎完全相同，經常被混淆誤認',
      '山吉歐維榭酸櫻桃番茄葉；內比歐露玫瑰焦油單寧更高',
      '內比歐露顏色反而較深，單寧也反而較輕盈',
      '山吉歐維榭的單寧與酸度反而都高於內比歐露'
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: [
      '兩者風味特徵幾乎完全相同，混調無實質意義',
      '格那希單寧與酸度反而更高，希哈則酒精度較高',
      '格那希單寧酸度低酒精高；希哈單寧酸度更高帶胡椒',
      '格那希反而提供胡椒辛香，希哈提供甜熟果香'
    ],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: [
      '兩者主要差異其實在於甜度，阿根廷版本明顯偏甜型',
      '法國版本質樸緊澀；阿根廷版本深邃圓潤濃郁',
      '阿根廷版本風格反而質樸緊澀，法國版本圓潤香甜',
      '法國卡歐版本的顏色反而比阿根廷版本更深邃'
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: [
      ...
      '兩者風味特徵幾乎完全相同，難以區分辨別出來',
      '希哈的果香調性反而比馬爾貝克更甜美圓潤許多',
      '馬爾貝克反而以黑胡椒辛香作為其招牌特徵香氣'
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      '高酒精濃度只出現在少數酒莊的頂級款，並非這個品種普遍常見的特性',
  ...
  },
  {
    ...
    options: [
      '名稱純粹是釀酒師發明的商標，無實質語源根據',
      '字首Gewürz意為「甜」，強調此品種必然是甜酒',
      '名稱源自法國阿爾薩斯地區某個知名城堡',
  ...
  },
  {
    ...
    options: [
      ...
      '主要用於提升貴腐甜酒的清爽酸度，酒體與蜂蠟質地反而來自白蘇維濃'
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      '兩者角色互補主要體現在甜度而非酸度骨架，Furmint其實負責提供圓潤甜感',
