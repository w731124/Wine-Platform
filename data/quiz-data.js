...
const QUIZ_BANK = [
  ...
  },
  {
    ...
    options: [
      '兩者酸度皆偏低，是柔和圓潤風格的代表',
      '只有Riesling酸度高，Sauvignon Blanc酸度中等',
  ...
  },
  {
    ...
    options: [
      '三大品種中只有Chardonnay對氣泡酒風格有實質貢獻，其餘僅供混調基酒使用',
  ...
  },
  {
    ...
    options: [
      '與水槽法相同，直接在大型加壓槽中進行二次發酵，完全不經瓶中發酵階段',
