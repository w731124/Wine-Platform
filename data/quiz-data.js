...
const QUIZ_BANK = [
  ...
  },
  {
    ...
    options: [
      '由磚紅色轉為鮮豔紫紅色',
      '由年輕的紫紅色，隨陳年逐漸轉為磚紅色、甚至帶橘色調',
      '顏色完全不會隨陳年改變',
      '由白色轉為粉紅色'
    ],
    correctIndex: 1,
    explanation: '紅酒色素會隨陳年逐漸與單寧結合沉澱，顏色由紫紅漸轉磚紅、石榴紅。'
  },
  {
    id: 'lo2-022',
    lo: 2,
    ...
    options: [
      ...
      '糖分與酸度',
      '只有酒精濃度',
      '顏色與香氣風味（不含單寧，因白酒單寧含量極低）'
    ],
    correctIndex: 3,
    explanation: '官方規格明列白酒瓶陳關鍵變化為Colour, Aromas and flavours兩項，不像紅酒額外列出Tannin。'
  },
  {
    id: 'lo2-023',
    lo: 2,
    ...
    options: [
      '由年輕的淺黃綠色，隨陳年逐漸加深轉為金黃色、甚至琥珀色',
      '由金黃色轉為無色透明',
      '顏色完全不會隨陳年改變',
      '由白色轉為紫紅色'
    ],
    correctIndex: 0,
    explanation: '與紅酒陳年顏色變淺的趨勢相反，白酒陳年通常顏色會逐漸加深。'
  },
  {
    id: 'lo2-024',
    lo: 2,
    ...
    options: [
      '完全保持不變，永遠停留在年輕果香階段',
      '香氣會變得更接近紅酒',
      '新鮮果香逐漸減弱，發展出蜂蜜、烤堅果、汽油（如老年份Riesling）等更複雜的三級陳年香氣',
      '只會產生負面的氧化異味，沒有正面的陳年價值'
    ],
    correctIndex: 2,
    explanation: '白酒陳年香氣的演變是官方規格認可的正面熟成現象，需區分「合宜的陳年演變」與「缺陷」兩個概念。'
  },
  {
    id: 'lo3-cha-001',
    lo: 3,
